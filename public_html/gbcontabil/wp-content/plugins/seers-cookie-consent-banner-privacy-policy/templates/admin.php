                        ...
                        <div class="seers-content-col tile-style">
                            <form method="post" id="wp_plugin" action="<?php echo esc_url(str_replace('%7E', '~', $S_URI)); ?>">
                                <fieldset>
                                    ...
                                    <div style="float:right;"><input type="submit" name="SCCBPP_cookieid" id="SCCBPP_cookieid" disabled value="<?php esc_html_e('Activate','Seers-Cookie-Consent-Banner-Privacy-Policy'); ?>" style="clear: both;" ></div>
...
<!--                            </div>-->
                            ...
                            <div class="seers-panel seers-mb-30">
                                ...
                                <div class="seers-pr">
                                    <div class="color-pick-hol">
                                        ...
                                        <input type="color" name="agree_btn_color" id="agree_btn_color" value="<?php if(get_option('SCCBPP_cookie_consent_agree_btn_color')!=''){ esc_html_e(get_option('SCCBPP_cookie_consent_agree_btn_color')); }else{ echo "#3B6EF8"; }?>" class="seers-banner-custom-color">
                            ...
                            <div class="seers-panel seers-mb-30">
                                ...
                                <div class="seers-pr">
                                    <div class="color-pick-hol">
                                        <label class="seers-color-label">Button Colour:</label>
                                        <input type="color" name="disagree_btn_color" id="disagree_btn_color" value="<?php if(get_option('SCCBPP_cookie_consent_disagree_btn_color')!=''){ esc_html_e(get_option('SCCBPP_cookie_consent_disagree_btn_color')); }else{ echo "#3B6EF8"; }?>" class="seers-banner-custom-color">
