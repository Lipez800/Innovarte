...
get_header();
	...
	// início das variáveis slide
$imagem_slide_home_01 = get_field('imagem_slide_home_01');

$titulo_principal_slide_home_01 = get_field('titulo_principal_slide_home_01');

$sub_titulo_slide_home_01 = get_field('sub_titulo_slide_home_01');

$descricao_do_botao_slide_home_01 = get_field('descricao_do_botao_slide_home_01');

$url_do_botao_slide_home_01 = get_field('url_do_botao_slide_home_01');

	//início das variáveis slide 02
$imagem_slide_home02 = get_field('imagem_slide_home02');

$titulo_principal_slide_home_02 = get_field('titulo_principal_slide_home_02');

$sub_titulo_slide_home_02 = get_field('sub_titulo_slide_home_02');

$descricao_do_botao_slide_home_02 = get_field('descricao_do_botao_slide_home_02');

$url_do_botao_slide_home_02 = get_field('url_do_botao_slide_home_02');

	// início das variáveis nossas soluções
$titulo_principal_home_solucoes = get_field('titulo_principal_home_solucoes');

$conteudo_home_solucoes = get_field('conteudo_home_solucoes');

	// início das variáveis nossos serviços
$titulo_principal_home_servicos = get_field('titulo_principal_home_servicos');

$titulo_topicos_servicos_home = get_field('titulo_topicos_servicos_home');

$sub_titulo_servicos_home = get_field('sub_titulo_servicos_home');

$imagem_nossos_servicos = get_field ('imagem_nossos_servicos');

	//Quebra de página

$imagem_quebra_pagina = get_field('imagem_quebra_pagina');

$titulo_quebra_pagina = get_field('titulo_quebra_pagina');

$botao = get_field('botao');

$url_do_botao = get_field('url_do_botao');
...
<section class="home-slider owl-carousel">
	<div class="slider-item" style="background-image:url('<?php echo $imagem_slide_home_01; ?>');">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
				<div class="col-md-7 ftco-animate mb-md-5">
					
					<h1 class="mb-4"><?php echo $titulo_principal_slide_home_01;?></h1>
					<span class="subheading"><?php echo $sub_titulo_slide_home_01;?></span>
					<p><a href="<?php echo $url_do_botao_slide_home_01;?>" class="btn btn-primary px-4 py-3 mt-3"><?php echo $descricao_do_botao_slide_home_01;?></a></p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="slider-item" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/images/bg_2.jpg);">
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
				<div class="col-md-7 ftco-animate mb-md-5">
					<h1 class="mb-4"><?php echo $titulo_principal_slide_home_02; ?> </h1>
					<span class="subheading"><?php echo $sub_titulo_slide_home_02;?></span>
					<p><a href="<?php echo $url_do_botao_slide_home_02; ?>" class="btn btn-primary px-4 py-3 mt-3"><?php echo $descricao_do_botao_slide_home_02; ?></a></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row d-flex no-gutters align-items-stretch	consult-wrap">
			<div class="col-md-5 wrap-about align-items-stretch d-flex">
				<div class="ftco-animate bg-primary align-self-stretch px-4 py-5 w-100">
					<h2 class="heading-white mb-4">Solicite uma Proposta</h2>
			...
			<div class="col-md-7 wrap-about ftco-animate align-items-stretch d-flex">
				<div class="bg-white p-5">
					<h2 class="mb-4"><?php echo $titulo_principal_home_solucoes;?></h2>
					<div class="row">
						<div class="col-lg-12 row">

							<?php

							while ( have_rows('conteudo_home_solucoes') ) : the_row();
								
								?>

								<!-- INÍCIO NOSSAS SOLUÇÕES -->
								<div class="services col-lg-6">
									<div class="icon mt-2 d-flex align-items-center"><span class="<?php the_sub_field('icone'); ?>"></span></div>
	...
	<div class="container">
		<div class="row justify-content-center mb-5">
			<div class="col-md-8 text-center heading-section ftco-animate">
				...
				<h2 class="mb-4"><?php echo $titulo_principal_home_servicos;?></h2>
				<p></p>
			</div>
		</div>
		...
		<div class="row tabulation mt-4 ftco-animate">
			<div class="col-md-4">
				<ul class="nav nav-pills nav-fill d-md-flex d-block flex-column">
					<?php if (have_rows('titulo_topicos_servicos_home')): 
						$primeiro = true;
						while( have_rows('titulo_topicos_servicos_home') ) : the_row();
							...
							if ($primeiro == true) { 
								...
								<li class="nav-item text-left">
									<a class="nav-link active py-4" data-toggle="tab" href="#<?php echo $id;?>"><?php echo $titulo;?></a>
								</li>
								...
								<li class="nav-item text-left">
									<a class="nav-link py-4" data-toggle="tab" href="#<?php echo $id;?>"><?php echo $titulo;?></a>
								</li>
						...
						while( have_rows('titulo_topicos_servicos_home') ) : the_row();
							...
							if ($primeiro == true) { 
								...
								<div class="tab-pane container p-0 active" id="<?php echo $id;?>">
									...
									<h3 style="margin-top:20px"><a href="#"><?php echo $titulo;?></a></h3>
...
<!-- INÍCIO CONTABIL. PEQUENAS EMPRESAS -->
<section class="ftco-intro ftco-no-pb img" style="background-image: url('<?php echo $imagem_quebra_pagina;?>);" style="background: linear-gradient(45deg, #218488 0%, #218488 100%);">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-9 col-md-8 d-flex align-items-center heading-section heading-section-white ftco-animate">
				<h2 class="mb-3 mb-md-0"><?php echo $titulo_quebra_pagina;?></h2>
			</div>
			<div class="col-lg-3 col-md-4 ftco-animate">
				<p class="mb-0"><a href="#" class="btn btn-secondary py-3 px-4"><?php echo $botao;?></a></p>
			</div>
		</div>	
	</div>
</section>
<!-- FIM CONTABIL. PEQUENAS EMPRESAS -->

<!-- INÍCIO POSTS RECENTES -->
<section class="ftco-section">
	<div class="container">
		<div class="row justify-content-center mb-5 pb-2">
			<div class="col-md-8 text-center heading-section ftco-animate">
				<span class="subheading"></span>
				<h2 class="mb-4">Posts mais recentes</h2>
				<p></p>
			</div>
		</div>
		<div class="row">
			...
			while($aRecentPosts->have_posts()) : $aRecentPosts->the_post();
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('<?php the_post_thumbnail_url(); ?>');">
						...
						<div class="text border border-top-0 p-4">
							...
							<div class="d-flex align-items-center mt-4">
								<p class="mb-0"><a href="https://agenciainnovarte.com.br/gbcontabil/blog/" class="btn btn-primary">Continuar Lendo </a></p>
								<p class="ml-auto mb-0">
									<a href="#" class="mr-2" style="color:#208488;">Admin</a>
		...
		<div id="mainSlider" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<span  class="d-block w-100" style="opacity:0.8; height:350px; background: #208488;"></span>
					<div class="carousel-caption d-md-block">
						<h2>"Excelente empresa, sempre cuidando bem do que mais importa para mim e tudo dentro do prazo."</h2>
						<p>Ana Lúcia Magazine</p>					
					</div>
				</div>
