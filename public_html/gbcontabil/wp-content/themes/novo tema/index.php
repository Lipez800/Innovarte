...
<section class="hero-wrap hero-wrap-2" style="background-image: url('https://agenciainnovarte.com.br/gbcontabil/wp-content/uploads/2020/06/bg_1.jpg');">
					...
					<div class="blog-entry">
						...
						<div class="text border border-top-0 p-4">
							...
							<div class="d-flex align-items-center mt-4">
								<p class="mb-0"><a href="<?php the_permalink() ?>" class="btn btn-primary">Continue Lendo</a></p>
