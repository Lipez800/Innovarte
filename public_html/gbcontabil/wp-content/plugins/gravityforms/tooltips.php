...
$__gf_tooltips = array(
	...
	'import_select_file'                          => '<h6>' . __( 'Select Files', 'gravityforms' ) . '</h6>' . __( 'Click the file selection button to upload a Gravity Forms export file from your computer. Please make sure your file has the .json extension, and that it was generated by the Gravity Forms Export tool.', 'gravityforms' ),
